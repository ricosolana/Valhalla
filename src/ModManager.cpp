...
void IModManager::LoadAPI() {    
    ...
    m_state.new_usertype<DataWriter>("DataWriter",
        ...
        "pos", sol::property(&DataWriter::Position, &DataWriter::SetPosition), //& DataWriter::m_pos,
    ...
    m_state.new_usertype<DataReader>("DataReader",
        ...
        "pos", sol::property(&DataReader::Position, &DataReader::SetPosition), //& DataWriter::m_pos,
