...
void avledet::api::init_zone(sol::table table) {
    ...
    table.new_usertype<Dungeon>("Dungeon",
        sol::no_constructor
    ...
    table.new_usertype<IDungeonManager>("IDungeonManager",
        "find_dungeon", [](IDungeonManager& self, std::string_view name) { return self.find_dungeon(avledet::util::get_stable_hash(name)); },
    ...
    table.new_usertype<IZoneManager::Feature::Instance>("FeatureInstance",
