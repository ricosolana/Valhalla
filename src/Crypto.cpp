...
#define D 0x10325476
    ...
    static std::uint32_t S[] = {7,  12, 17, 22, 7,  12, 17, 22, 7,  12, 17, 22, 7,  12, 17, 22, 5,  9,  14, 20, 5,  9,
    ...
    */
    static std::uint8_t PADDING[] = {   0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
#define I(X, Y, Z) (Y ^ (X | ~Z))
            ...
            if (offset % 64 == 0) {
                for (unsigned int j = 0; j < 16; ++j) {
                    ...
                    input[j] = (std::uint32_t)(ctx->input[(j * 4) + 3]) << 24 |
                        ...
                        (std::uint32_t)(ctx->input[(j * 4) + 1]) << 8 | (std::uint32_t)(ctx->input[(j * 4)]);
                }
    ...
    */
    void md5Finalize(MD5Context* ctx) {
        ...
        for (unsigned int j = 0; j < 14; ++j) {
            input[j] = (std::uint32_t)(ctx->input[(j * 4) + 3]) << 24 | (std::uint32_t)(ctx->input[(j * 4) + 2]) << 16 |
                (std::uint32_t)(ctx->input[(j * 4) + 1]) << 8 | (std::uint32_t)(ctx->input[(j * 4)]);
        }
    ...
    */
    ...
    std::string md5(std::string_view in) {
        MD5Context ctx;
        md5Init(&ctx);
        md5Update(&ctx, (std::uint8_t*)in.data(), in.length());
        md5Finalize(&ctx);

        return std::string((char*)ctx.digest, sizeof(ctx.digest));
    }
