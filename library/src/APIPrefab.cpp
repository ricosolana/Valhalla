...
void avledet::api::init_prefab(sol::table table) {
    ...
    table.new_usertype<Prefab>("Prefab",
        sol::no_constructor,
    ...
    table.new_usertype<IPrefabManager>("IPrefabManager",
        "get_prefab", sol::overload(
            sol::resolve<const Prefab*(avledet::util::Hash) const>(&IPrefabManager::find_prefab),
