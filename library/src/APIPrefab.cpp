...
void avledet::api::init_prefab(sol::table table)
{
    ...
    table.new_enum("Flag", "NONE", Prefab::Flag::NONE,

                   "SCALE", Prefab::Flag::SYNC_INITIAL_SCALE, "DISTANT", Prefab::Flag::DISTANT, "PERSISTENT",
                   Prefab::Flag::PERSISTENT, "TYPE1", Prefab::Flag::TYPE1, "TYPE2", Prefab::Flag::TYPE2,
                   ...
                   "MINE_ROCK_5", Prefab::Flag::MINE_ROCK_5, "TREE_BASE", Prefab::Flag::TREE_BASE, "TREE_LOG",
                   Prefab::Flag::TREE_LOG,

                   "DUNGEON", Prefab::Flag::DUNGEON, "TERRAIN_MODIFIER", Prefab::Flag::TERRAIN_MODIFIER,
                   "CREATURE_SPAWNER", Prefab::Flag::CREATURE_SPAWNER);

    table.new_usertype<Prefab>("Prefab", sol::no_constructor, "name", sol::readonly(&Prefab::m_name), "hash",
    ...
    table["PrefabManager"] = PrefabManager();
    table.new_usertype<IPrefabManager>(
