...
void avledet::api::init_types(sol::table table) {
    ...
    table.new_usertype<Bytes>("Bytes",
    ...
    table.new_usertype<DataWriter>("Writer",
    ...
    table.new_usertype<DataReader>("Reader",
    ...
    table.new_usertype<Int64Wrapper>("Int64",
    ...
    table.new_usertype<UInt64Wrapper>("UInt64",
    ...
    table.new_usertype<ZStdCompressor>("ZStdCompressor",
    ...
    table.new_usertype<ZStdDecompressor>("ZStdDecompressor",
    ...
    table.new_usertype<Deflater>("Deflater",
        ...
        "compress", sol::resolve<std::optional<Bytes>(Bytes const&)>(&Deflater::Compress)
    );
    ...
    table.new_usertype<Inflater>("Inflater",
        ...
        "decompress", sol::resolve<std::optional<Bytes>(Bytes const&)>(&Inflater::Decompress)
    );
