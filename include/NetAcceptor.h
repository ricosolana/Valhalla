    ...
    private:
        ...
        private: 
            virtual void Run(void* pvParam) {
                ...
                AcceptorSteam* pOuter = reinterpret_cast<AcceptorSteam*>(reinterpret_cast<char*>(this) - ((::size_t) & reinterpret_cast<char const volatile&>((((AcceptorSteam*)0)->m_steamcallback_OnSteamStatusChanged))));
