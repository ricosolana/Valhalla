...
namespace avledet::util {
    ...
    struct Color32 {
        ...
        constexpr Color32(avledet::util::Byte r, avledet::util::Byte g, avledet::util::Byte b) : r(r), g(g), b(b), a(1) {}
        constexpr Color32(avledet::util::Byte r, avledet::util::Byte g, avledet::util::Byte b, avledet::util::Byte a) : r(r), g(g), b(b), a(a) {}
